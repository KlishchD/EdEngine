...
// }
// 
// void ComponentDetailsWidget::Tick(f32 DeltaTime)
// {
...
// 
//         if (ImGui::InputText(("##Name" + std::to_string((i32)m_Component.get())).c_str(), name, 1024))
//         {
...
// 	}
// 
// 	if (f32 intensity = component->GetIntensity(); ImGui::SliderFloat("Light Intensity", &intensity, 0.0f, 100000.0f))
// 	{
...
// 
//     if (f32 radius = component->GetRadius(); ImGui::SliderFloat("Light Radius", &radius, 0.0f, 1000.0f))
//     {
//         component->SetRadius(radius);
//     }
// 
//     if (i32 size = component->GetShadowFilterSize(); ImGui::SliderInt("PFC filter size", &size, 1, 64))
//     {
...
//     LightComponentDetails();
// 
//     if (f32 angle = glm::degrees(component->GetInnerAngle()); ImGui::SliderFloat("Light inner angle", &angle, 0.0f, 89.0f))
//     {
//         component->SetInnerAngle(glm::radians(angle));
//     }
// 
//     if (f32 angle = glm::degrees(component->GetOuterAngle()); ImGui::SliderFloat("Light outer angle", &angle, 0.0f, 89.0f))
//     {
//         component->SetOuterAngle(glm::radians(angle));
//     }
// 
//     if (f32 distance = component->GetMaxDistance(); ImGui::SliderFloat("Light max effective distance", &distance, 0.0f, 1000.0f))
//     {
//         component->SetMaxDistance(distance);
//     }
// 
//     if (i32 size = component->GetShadowFilterSize(); ImGui::SliderInt("PCF filter size", &size, 1, 64))
//     {
//         component->SetShadowFilterSize(size);
//     }
// 
//     if (f32 radius = component->GetShadowFilterRadius(); ImGui::SliderFloat("PCF filter radius", &radius, 1.0f, 10.0f))
//     {
...
// 
//     if (i32 count = component->GetShadowCascadesCount(); ImGui::SliderInt("CSM cascades", &count, 1, 4))
//     {
//         component->SetShadowCascadesCount(count);
//     }
// 
//     if (f32 multiplier = component->GetShadowMapZMultiplier(); ImGui::SliderFloat("CSM cascade z multiplier", &multiplier, 1.0f, 100.0f, "%.10f"))
//     {
