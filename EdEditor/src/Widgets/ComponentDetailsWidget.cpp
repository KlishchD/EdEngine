...
void ComponentDetailsWidget::Tick(float DeltaTime)
{
  ...
  if (m_Component)
  {
    ...
    {
    case ComponentType::StaticMesh: StaticMeshDetails();
      break;
    case ComponentType::PointLight: PointLightDetails();
      break;
    case ComponentType::SpotLight: SpotLightDetails();
      break;
    case ComponentType::DirectionalLight: DirectionalLightDetails();
      break;
    }
  }
}
...
void ComponentDetailsWidget::StaticMeshDetails()
{
  ...
  {
    ImGui::TableNextColumn();
    ImGui::Text("Add child component");
