...
{
  ED_LOG(Renderer, info, "Started initializing Renderer")
  ...
  m_TextVBO = RenderingHelper::CreateVertexBuffer("Text quad vertex buffer", nullptr, 20 * sizeof(float), textVBOlayout, BufferUsage::DynamicDraw);
  m_QuadVBO = RenderingHelper::CreateVertexBuffer("Quad vertex buffer", square, 24 * sizeof(float), textVBOlayout, BufferUsage::StaticDraw);
  // 
  //   {
  ...
  ED_LOG(Renderer, info, "Finished initializing Renderer")
}
