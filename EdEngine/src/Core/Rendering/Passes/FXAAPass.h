...
ED_BEGIN_RENDER_PASS_PARAMETERS_DECLARATION(FXAAPassParameters, Compute)

	ED_RENDER_PASS_DECLARE_RESOURCE(Texture2D, Output, "FXAA.Output")

	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2D, LightCombined, "LightBuffer.Combined")

ED_END_SHADER_PARAMETERS_DECLARATION()

ED_BEGIN_SHADER_PARAMETERS_DECLARATION(FXAAPassShaderParameters)
