...
ED_BEGIN_RENDER_PASS_PARAMETERS_DECLARATION(TAAPassParameters, Base)

	ED_RENDER_PASS_DECLARE_RENDER_TARGET(Texture2D, Output, Color16, "TAA.Output")

	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2D, SceneBase, "LightBuffer.Combined")
	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2D, SceneDepth, "GBuffer.Depth")
	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2D, SceneVelocity, "GBuffer.Velocity")

ED_END_RENDER_PASS_PARAMETERS_DECLARATION()

ED_BEGIN_SHADER_PARAMETERS_DECLARATION(TAAPassShaderParameters)
