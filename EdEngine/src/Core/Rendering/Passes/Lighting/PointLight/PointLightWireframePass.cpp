...
void PointLightWireframePass::Update(float deltaSeconds)
{
	RenderPass<PointLightWireframePassParameters, PointLightWireframePassShaderParameters>::Update(deltaSeconds);
