...
ED_BEGIN_RENDER_PASS_PARAMETERS_DECLARATION(DirecationalLightShadingParameters, Base)
	...
	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2DArray, ShadowMap, "DirectionalLightPass.ShadowMap")

	ED_RENDER_PASS_GRAPH_OBJECT_PTR_PARAMETER(DirectionalLightComponent, Light, "DirectionalLightPass.Light")
	ED_RENDER_PASS_GRAPH_OBJECT_PTR_PARAMETER(CameraComponent, Camera, "Camera")
	ED_RENDER_PASS_GRAPH_PARAMETER(std::vector<glm::mat4>, ShadowViewProjectionMatrices, "DirectionalLightPass.ShadowViewProjectionMatrices")

ED_END_RENDER_PASS_PARAMETERS_DECLARATION()

ED_BEGIN_SHADER_PARAMETERS_DECLARATION(DirectionalLightShadingShaderParameters)
