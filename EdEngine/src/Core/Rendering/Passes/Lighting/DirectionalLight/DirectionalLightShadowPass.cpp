...
void DirectionalLightShadowPass::Update(float deltaSeconds)
{
	RenderPass<DirectionalLightShadowPassParameters, DirectionalLightShadowPassShaderParameters>::Update(deltaSeconds);
