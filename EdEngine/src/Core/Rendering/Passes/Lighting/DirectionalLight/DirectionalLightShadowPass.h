...
ED_BEGIN_RENDER_PASS_PARAMETERS_DECLARATION(DirectionalLightShadowPassParameters, Base)
	...
	ED_RENDER_PASS_DECLARE_GRAPH_PARAMETER(std::vector<glm::mat4>, ShadowViewProjectionMatrices, "DirectionalLightPass.ShadowViewProjectionMatrices")

ED_END_RENDER_PASS_PARAMETERS_DECLARATION()

ED_BEGIN_SHADER_PARAMETERS_DECLARATION(DirectionalLightShadowPassShaderParameters)
