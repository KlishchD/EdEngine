...
void DirectionalLightShadingRenderPass::Update(float deltaSeconds)
{
	RenderPass<DirecationalLightShadingParameters, DirectionalLightShadingShaderParameters>::Update(deltaSeconds);
