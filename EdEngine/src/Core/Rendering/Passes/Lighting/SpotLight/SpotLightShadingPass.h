...
ED_BEGIN_RENDER_PASS_PARAMETERS_DECLARATION(SpotLightShadingParameters, Base)
	...
	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2D, ShadowMap, "SpotLightPass.ShadowMap")

	ED_RENDER_PASS_GRAPH_PARAMETER(glm::mat4, ShadowProjectionViewMatrix, "SpotLightPass.ShadowProjectionViewMatrix")
	ED_RENDER_PASS_GRAPH_PARAMETER(std::vector<glm::vec3>, LightMeshVertices, "SpotLightPass.LightMeshVertices")
	ED_RENDER_PASS_GRAPH_PARAMETER(std::vector<int32_t>, LightMeshIndices, "SpotLightPass.LightMeshIndices")
...
ED_BEGIN_SHADER_PARAMETERS_DECLARATION(SpotLightShadingShaderParameters)
