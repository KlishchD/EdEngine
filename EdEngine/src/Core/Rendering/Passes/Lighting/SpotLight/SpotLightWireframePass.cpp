...
void SpotLightWireframePass::Update(float deltaSeconds)
{
	RenderPass<SpotLightWireframePassParameters, SpotLightWireframePassShaderParameters>::Update(deltaSeconds);
