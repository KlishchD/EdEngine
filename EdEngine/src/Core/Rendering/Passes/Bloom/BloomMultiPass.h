...
ED_BEGIN_RENDER_PASS_PARAMETERS_DECLARATION(BloomMultiPassParameters, Multi)

	ED_RENDER_PASS_DECLARE_GRAPH_PARAMETER(uint32_t, DownscaleCount, "Bloom.DownscaleCount")
