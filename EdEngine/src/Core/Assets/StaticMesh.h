...
public:
    ...
    virtual void SetDescriptor(std::shared_ptr<AssetDescriptor> inDescriptor) override;
    virtual void SyncDescriptor() override;

    void AddSubmesh(std::shared_ptr<StaticSubmesh> submesh) { m_Submeshes.push_back(submesh); }
