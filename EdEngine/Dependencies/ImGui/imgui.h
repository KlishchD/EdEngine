...
// You are totally free to apply whatever Transform matrix to want to the data (depending on the use of the Transform you may want to apply it to ClipRect as well!)
