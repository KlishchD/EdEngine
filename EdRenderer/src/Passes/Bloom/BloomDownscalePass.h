...
// 
// 	ED_RENDER_PASS_RESOURCE_REFERENCE(Texture2D, Previous, "Bloom.Intermediate" + std::to_string(std::max<i32>(Parameters.InstanceNumber - 1, 1)), Read)
// 
// 	ED_RENDER_PASS_PARAMETER(u32, DownscaleCount, "Bloom.DownscaleCount", Read)
// 
