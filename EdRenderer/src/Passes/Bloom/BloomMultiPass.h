...
// 
// 	ED_RENDER_PASS_DECLARE_PARAMETER(u32, DownscaleCount, "Bloom.DownscaleCount")
// 
...
// {
// public:
// 	static const u32 MaxBloomDownscalingCount = 8;
// 
// public:
...
// 
// 	f32 GetBloomMixStrength() const;
// 	void SetBloomMixStrength(f32 strength);
// 	
// 	u32 GetBloomDownscaleCount() const;
// 	void SetBloomDownscaleCount(u32 count);
// 
// protected:
