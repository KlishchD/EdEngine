...
// 
// 	ED_SHADER_PARAMETER(Float, f32, Cascades)
...
// {
// 	static const u32 MinShadowCascadesCount = 1;
// 	static const u32 MaxShadowCascadesCount = 4;
// 	static const u32 ShadowCascadeMinSize = 2048;
// public:
