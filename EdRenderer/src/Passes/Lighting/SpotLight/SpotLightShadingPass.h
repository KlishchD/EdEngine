...
// 	ED_RENDER_PASS_PARAMETER(std::vector<i32>,   LightMeshIndices,           "SpotLightPass.LightMeshIndices",           Read)
// 
...
// 
// 	ED_SHADER_PARAMETER(Float, f32, FarPlane)
// 	ED_SHADER_PARAMETER(Float2, glm::vec2, PixelSize)
// 
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float3, glm::vec3, Color)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, MaxDistance)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, Intensity)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float3, glm::vec3, Position)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, InnerAngleCos)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, OuterAngleCos)
// 
...
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, ShadowFilterSize)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, ShadowFilterRadius)
// 
...
// 
// 	void SetShadowSamplesBlockCount(u32 count);
// 	u32 GetShadowSamplesBlocksCount() const;
// 
// 	void SetShadowSamplesBlockSize(u32 size);
// 	u32 GetShadowSamplesBlockSize() const;
// 
// protected:
// 	void UpdateShadowSamplesTexture();
// 
// protected:
// 	u32 m_ShadowSamplesBlockCount = 10;
// 	u32 m_ShadowSamplesBlockSize = 32;
// };