...
// 		std::vector<i32>& indices = m_Parameters.LightMeshIndices;
// 
// 		VertexBufferLayout lightVBOLayout = { { "position", ShaderDataType::Float3 } };
// 		m_Parameters.LightMeshVBO = RenderingHelper::CreateVertexBuffer(vertices.data(), 3.0f * sizeof(f32) * vertices.size(), lightVBOLayout, BufferUsage::StaticDraw);
// 		m_Parameters.LightMeshIBO = RenderingHelper::CreateIndexBuffer(indices.data(), sizeof(i32) * indices.size(), BufferUsage::StaticDraw);
// 	}
// 
...
// 	}
// 
// 	const f32 angle = light->GetOuterAngle();
// 	const f32 length = light->GetMaxDistance();
...
// }
// 
// void SpotLightShadingPass::SetShadowSamplesBlockCount(u32 count)
// {
// 	m_ShadowSamplesBlockCount = count;
// 	UpdateShadowSamplesTexture();
// }
// 
// u32 SpotLightShadingPass::GetShadowSamplesBlocksCount() const
// {
// 	return m_ShadowSamplesBlockCount;
// }
// 
// void SpotLightShadingPass::SetShadowSamplesBlockSize(u32 size)
// {
// 	m_ShadowSamplesBlockSize = size;
// 	UpdateShadowSamplesTexture();
// }
// 
// u32 SpotLightShadingPass::GetShadowSamplesBlockSize() const
// {
...
// 	Texture2DData data(m_ShadowSamplesBlockSize * m_ShadowSamplesBlockCount, m_ShadowSamplesBlockSize, (u8*) &samples[0], samples.size() * sizeof(glm::vec2), false);
// 
