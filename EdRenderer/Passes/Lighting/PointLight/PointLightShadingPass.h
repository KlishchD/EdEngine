...
// 	ED_RENDER_PASS_PARAMETER(std::vector<i32>,   LightMeshIndices,  "PointLightPass.LightMeshIndices",  Read)
// 
...
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, Radius)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Bool, bool, UseShadowMap)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, ShadowMapPixelSize)
// 	ED_SHADER_PARAMETER_SUBSTRUCT(Light, Float, f32, FilterSize)
